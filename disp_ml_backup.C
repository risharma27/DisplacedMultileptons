...
Bool_t disp_ml::Process(Long64_t entry)
{
  ...
  if(GoodEvt){
	...
	if(76.0<invmass_ll && invmass_ll<106.0 && metpt<40.0){
      ...
      float 3L_invmass_lll = -1.0, 3L_invmass_l0l1 = -1.0, 3L_invmass_l1l2 = -1.0,  3L_invmass_l2l0 = -1.0, 3L_ht = 0.0, 3L_lt = 0.0, 3L_st = 0.0;
      if((int)promptLepton.size()==3){
	3L_invmass_lll = (promptLepton.at(0).v+promptLepton.at(1).v+promptLepton.at(2).v).M();
	3L_invmass_l0l1 = (promptLepton.at(0).v+promptLepton.at(1).v).M();
	3L_invmass_l1l2 = (promptLepton.at(1).v+promptLepton.at(2).v).M();
	3L_invmass_l2l0 = (promptLepton.at(2).v+promptLepton.at(0).v).M();
	h._3l[0]->Fill(3L_invmass_lll);
	h._3l[1]->Fill(3L_invmass_l0l1);
	h._3l[2]->Fill(3L_invmass_l1l2);
	h._3l[3]->Fill(3L_invmass_l2l0);
	h._3l[4]->Fill(metpt);
	...
	for(int i=0; i<(int)promptLepton.size(); i++){
	  3L_lt = 3L_lt + promptLepton.at(i).v.Pt();
	}
	h._3l[8]->Fill(3L_lt);
	h._3l[9]->Fill((int)goodJet.size());
	for(int i=0; i<(int)goodJet.size(); i++){
	  3L_ht = 3L_ht + goodJet.at(i).v.Pt();
	}
	h._3l[10]->Fill(3L_ht);
	3L_st = 3L_ht + 3L_lt + metpt;
	h._3l[11]->Fill(3L_st);
      }
