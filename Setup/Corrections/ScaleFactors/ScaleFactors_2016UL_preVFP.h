...
//Electron Reco
double disp_ml::Electron_2016UL_Reco_preVFP(float pt, float eta){
...
//Electron IdIso
double disp_ml::Electron_2016UL_IDIso_preVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(10<pt && pt<=20){
...
//Muon Reco
double disp_ml::Muon_2016UL_Reco_preVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Muon ID
double disp_ml::Muon_2016UL_ID_preVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Muon Iso
double disp_ml::Muon_2016UL_Iso_preVFP(float pt, float eta){
  double scale_factor = 1.0;//default value
  if(fabs(eta)<=0.9){
...
//Taus AntiJet
double disp_ml::Tau_2016UL_AntiJet_preVFP(float pt){
  double scale_factor = 1.0;//default value
...
//Taus AntiEle
double disp_ml::Tau_2016UL_AntiEle_preVFP(float eta){
  double scale_factor = 1.0;//default value
...
//Taus AntiMu
double disp_ml::Tau_2016UL_AntiMu_preVFP(float eta){
  double scale_factor = 1.0;//default value
