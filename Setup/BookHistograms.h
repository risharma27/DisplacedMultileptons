void disp_ml::BookHistograms(){
  ...
  */
  ...
  h._2LonZ[2] = new TH1F("2LonZ_triggeff", "2LonZ_triggeff", 100, 0, 1);
  ...
  h.cr_qcd_2l1d[0] = new TH1F("cr_qcd_2l1d_met", "met", 200, 0, 200);
  h.cr_qcd_2l1d[1] = new TH1F("cr_qcd_2l1d_pt0", "pt0", 200, 0, 200);
  h.cr_qcd_2l1d[2] = new TH1F("cr_qcd_2l1d_pt1", "pt1", 200, 0, 200);
  h.cr_qcd_2l1d[3] = new TH1F("cr_qcd_2l1d_pt2", "pt2", 200, 0, 200);
  h.cr_qcd_2l1d[4] = new TH1F("cr_qcd_2l1d_lt", "lt", 500, 0, 500);
  h.cr_qcd_2l1d[5] = new TH1F("cr_qcd_2l1d_njets", "njets", 10, 0, 10);
  h.cr_qcd_2l1d[6] = new TH1F("cr_qcd_2l1d_bjets", "bjets", 10, 0, 10);
  h.cr_qcd_2l1d[7] = new TH1F("cr_qcd_2l1d_ht", "ht", 500, 0, 500);
  h.cr_qcd_2l1d[8] = new TH1F("cr_qcd_2l1d_mt0", "mt0", 200, 0, 200);
  h.cr_qcd_2l1d[9] = new TH1F("cr_qcd_2l1d_mt1", "mt1", 200, 0, 200);
  h.cr_qcd_2l1d[10] = new TH1F("cr_qcd_2l1d_mt2", "mt2", 200, 0, 200);
  h.cr_qcd_2l1d[11] = new TH1F("cr_qcd_2l1d_l0iso", "l0iso", 50, 0, 0.5);
  h.cr_qcd_2l1d[12] = new TH1F("cr_qcd_2l1d_l1iso", "l1iso", 50, 0, 0.5);
  h.cr_qcd_2l1d[13] = new TH1F("cr_qcd_2l1d_l2iso", "l2iso", 50, 0, 0.5);
  h.cr_qcd_2l1d[14] = new TH1F("cr_qcd_2l1d_dPhil0l1", "dPhil0l1", 32, 0, 3.2);
  h.cr_qcd_2l1d[15] = new TH1F("cr_qcd_2l1d_imassl0l1", "imassl0l1", 200, 0, 200);
  h.cr_qcd_2l1d[16] = new TH1F("cr_qcd_2l1d_l0sip3d", "l0sip3d", 500, 0, 50);
  h.cr_qcd_2l1d[17] = new TH1F("cr_qcd_2l1d_l1sip3d", "l1sip3d", 500, 0, 50);
  h.cr_qcd_2l1d[18] = new TH1F("cr_qcd_2l1d_l2sip3d", "l2sip3d", 500, 0, 50);
    
  h.cr_qcd_1l2d[0] = new TH1F("cr_qcd_1l2d_met", "met", 200, 0, 200);
  h.cr_qcd_1l2d[1] = new TH1F("cr_qcd_1l2d_pt0", "pt0", 200, 0, 200);
  h.cr_qcd_1l2d[2] = new TH1F("cr_qcd_1l2d_pt1", "pt1", 200, 0, 200);
  h.cr_qcd_1l2d[3] = new TH1F("cr_qcd_1l2d_pt2", "pt2", 200, 0, 200);
  h.cr_qcd_1l2d[4] = new TH1F("cr_qcd_1l2d_lt", "lt", 500, 0, 500);
  h.cr_qcd_1l2d[5] = new TH1F("cr_qcd_1l2d_njets", "njets", 10, 0, 10);
  h.cr_qcd_1l2d[6] = new TH1F("cr_qcd_1l2d_bjets", "bjets", 10, 0, 10);
  h.cr_qcd_1l2d[7] = new TH1F("cr_qcd_1l2d_ht", "ht", 500, 0, 500);
  h.cr_qcd_1l2d[8] = new TH1F("cr_qcd_1l2d_mt0", "mt0", 200, 0, 200);
  h.cr_qcd_1l2d[9] = new TH1F("cr_qcd_1l2d_mt1", "mt1", 200, 0, 200);
  h.cr_qcd_1l2d[10] = new TH1F("cr_qcd_1l2d_mt2", "mt2", 200, 0, 200);
  h.cr_qcd_1l2d[11] = new TH1F("cr_qcd_1l2d_l0iso", "l0iso", 50, 0, 0.5);
  h.cr_qcd_1l2d[12] = new TH1F("cr_qcd_1l2d_l1iso", "l1iso", 50, 0, 0.5);
  h.cr_qcd_1l2d[13] = new TH1F("cr_qcd_1l2d_l2iso", "l2iso", 50, 0, 0.5);
  h.cr_qcd_1l2d[14] = new TH1F("cr_qcd_1l2d_dPhil1l2", "dPhil1l2", 32, 0, 3.2);
  h.cr_qcd_1l2d[15] = new TH1F("cr_qcd_1l2d_imassl1l2", "imassl1l2", 200, 0, 200);
  h.cr_qcd_1l2d[16] = new TH1F("cr_qcd_1l2d_l0sip3d", "l0sip3d", 500, 0, 50);
  h.cr_qcd_1l2d[17] = new TH1F("cr_qcd_1l2d_l1sip3d", "l1sip3d", 500, 0, 50);
  h.cr_qcd_1l2d[18] = new TH1F("cr_qcd_1l2d_l2sip3d", "l2sip3d", 500, 0, 50);
  

  h.nevsel = new TH1F("nEvSel", "1: 2l1d, 2: 1l2d, 3: 3d", 5,0,5);
  h.count_1l2d = new TH1F("1l2d_count", "", 5,0,5);
  ...
  //2L1D and 1L2D flavor classified plots
  TString flav_type[5] = {"e", "mu", "ee", "mumu", "emu"}; //1st two for 2l1d and last three for 1l2d
  ...
  //1L2D
  int r=45; int s=0;
  for(int flav=2; flav<5; flav++){
    for(int plot=0; plot<15; plot++){
      TString name = "1l2d_" + flav_type[flav] + "_" + plotnames[plot];
      h.dispml_h[1][plot+r+s] = new TH1F(name,name,n_bins[plot],b_lo[plot],b_hi[plot]);
    }
    s=s+15;
  }
  ...
  for(int ievsel=0; ievsel<3; ievsel++){
    for(int iplot = 0; iplot<3; iplot++){
      ...
      h.dispml_h[ievsel][90+iplot] = new TH1F(name,name,100,0,10);
    }
  }
